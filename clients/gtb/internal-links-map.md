# Glasgow Thai Massage Blog — Internal Links Map

Use this file when writing any content for the GTB blog site. Link naturally to relevant pages using the anchor text suggestions. Aim for 3–5 internal links per article. Do not force links — only include them where they genuinely add value for the reader.

**Domains:**
- Blog site (this site): `https://blog.glasgowthaimassage.co.uk`
- Main GTM site (cross-brand): `https://glasgowthaimassage.co.uk`

**Linking priority:** Link internally within the blog site first. Link to the main GTM site for booking, services, and core business pages — these cross-domain links are brand links and are encouraged.
...
| Book an appointment | https://glasgowthaimassage.co.uk/booking-form/ | book a session, book online, book your appointment |
...
## Main GTM Site — Service Pages

Link to these from blog content whenever a specific treatment is mentioned.
...
## Main GTM Site — Health Condition Pages
...
Link to category archives when pointing readers toward more content on a broad topic.
...
## Blog Site — Key Posts: Thai Massage
...
## Blog Site — Key Posts: Conditions and Pain Relief
...
## Blog Site — Key Posts: Stay Healthy / Nutrition
...
3. **Services first** — always link to the relevant service page on glasgowthaimassage.co.uk when a treatment is mentioned
4. **Blog to blog** — link between blog posts on related topics to build topical depth
5. **Book CTA** — include one link to `https://glasgowthaimassage.co.uk/booking-form/` per article, ideally near a CTA paragraph
6. **No orphan content** — every new article should link to at least one existing article
7. **Cross-domain linking** — linking from this blog site to glasgowthaimassage.co.uk (and vice versa) is encouraged; both are the same brand
