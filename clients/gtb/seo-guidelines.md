# SEO Guidelines for GTB Content (Glasgow Thai Massage Blog Site)

This document outlines SEO best practices and requirements for all GTB content. GTB publishes to `blog.glasgowthaimassage.co.uk` — the dedicated blog subdomain for Glasgow Thai Massage. The main business site is `glasgowthaimassage.co.uk` (client abbreviation: GTM). These are the same business; cross-domain linking between GTB and GTM is encouraged and treated as internal brand linking.
